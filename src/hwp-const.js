...
(function (root) {
  ...
  H.PROP_BITS = [
    ...
    { bit: 12, name: '모바일 최적화', desc: '명세 개정 1.3(2018)에서 추가된 비트.' },
    { bit: 13, name: '개인 정보 보안 문서', desc: '개정 1.3에서 추가.' },
    { bit: 14, name: '변경 추적 문서', desc: '개정 1.3에서 추가.' },
    { bit: 15, name: '공공누리(KOGL) 저작권 문서', desc: '개정 1.3에서 추가.' },
    { bit: 16, name: '비디오 컨트롤 포함', desc: '개정 1.3에서 추가.' },
    { bit: 17, name: '차례 필드 컨트롤 포함', desc: '개정 1.3에서 추가. 18번부터 31번까지는 예약.' }
  ];
